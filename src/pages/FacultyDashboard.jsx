...
//         console.log("Studets:",resStudents.data);
        

//         const resCourses = await axios.get("http://localhost:5000/courses", {
//           headers: { Authorization: `Bearer ${token}` },
//         });
//         setCourses(resCourses.data);
//         console.log("Studets:",resCourses.data);
...
//       <h3 className="text-xl font-semibold mt-6 mb-2">My Students</h3>
//       <DataTable rows={students.students} />
//     </div>
//   );
// }
